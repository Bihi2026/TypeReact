...
export const storyVideoKind = v.union(v.literal("narrated"), v.literal("film"));

export const storyVideoStatus = v.union(
  v.literal("queued"),
...
export const storyVideoRequestSource = v.union(
  v.literal("auto_publish"),
  v.literal("writer"),
  v.literal("reader")
);

export const storyVideoVisibility = v.union(
  v.literal("private"),
  v.literal("public")
);

export const storyVideoAttributionConfidence = v.union(
  v.literal("high"),
  v.literal("degraded")
);

export const storyVideoDocFields = {
  storyId: v.id("stories"),
  ...
  writerId: v.id("writers"),
  authorClerkId: v.string(),
  requestedByClerkId: v.optional(v.string()),
  requestSource: storyVideoRequestSource,
  status: storyVideoStatus,
  error: v.optional(v.string()),
  styleNote: v.optional(v.string()),
  scriptJson: v.optional(v.string()),
  attributionConfidence: v.optional(storyVideoAttributionConfidence),
  visibility: storyVideoVisibility,
...
export const storyVideoSegmentKind = v.union(
  v.literal("tts_beat"),
  v.literal("paragraph_film"),
  v.literal("lipsync_beat"),
  v.literal("open_bed")
);

export const storyVideoSegmentDocFields = {
  videoId: v.id("storyVideos"),
  storyId: v.id("stories"),
  chapterNumber: v.number(),
  kind: storyVideoSegmentKind,
  paragraphIndex: v.optional(v.number()),
  beatIndex: v.optional(v.number()),
  speakerKey: v.optional(v.string()),
...
export const storyCharacterCastRole = v.union(
  v.literal("narrator"),
  v.literal("character")
);

export const storyCharacterCastDocFields = {
  storyId: v.id("stories"),
  key: v.string(),
  displayName: v.string(),
  voiceId: v.string(),
  role: storyCharacterCastRole,
  genderHint: v.optional(v.string()),
  updatedAt: v.number(),
};

export const storyCharacterLoraStatus = v.union(
  v.literal("uploading"),
  v.literal("training"),
  v.literal("ready"),
  v.literal("failed")
...
export const storyCharacterLoraDocFields = {
  storyId: v.id("stories"),
  characterKey: v.string(),
  status: storyCharacterLoraStatus,
  refStorageIds: v.array(v.id("_storage")),
  falLoraId: v.optional(v.string()),
...
export const writerSocialPlatform = v.union(
  v.literal("tiktok"),
  v.literal("youtube")
);

export const writerSocialAccountDocFields = {
  writerId: v.id("writers"),
  authorClerkId: v.string(),
...
export const storySocialPostStatus = v.union(
  v.literal("queued"),
  v.literal("uploading"),
  v.literal("posted"),
  v.literal("failed")
...
export const storySocialPostDocFields = {
  storyId: v.id("stories"),
  chapterNumber: v.number(),
  videoId: v.id("storyVideos"),
  writerId: v.id("writers"),
  platform: writerSocialPlatform,
  status: storySocialPostStatus,
  title: v.string(),
  caption: v.string(),
  watchUrl: v.string(),
